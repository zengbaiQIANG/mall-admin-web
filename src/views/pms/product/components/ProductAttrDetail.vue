    ...
    <el-form :model="value" ref="productAttrForm" label-width="120px" class="form-inner-container" size="small">
      <el-form-item label="Attribute Type：">
        <el-select v-model="value.productAttributeCategoryId"
                   placeholder="Please select the attribute type"
      ...
      <el-form-item label="Product Specifications：">
        ...
        <el-button
          type="primary"
          style="margin-top: 20px"
          @click="handleSyncProductSkuPrice">Synchronize prices
        </el-button>
        <el-button
          type="primary"
          style="margin-top: 20px"
      ...
      <el-form-item label="Product details:">
        <el-tabs v-model="activeHtmlName" type="card">
          ...
          <el-tab-pane label="Mobile terminal details" name="mobile">
            <tinymce :width="595" :height="300" v-model="value.detailMobileHtml"></tinymce>
          </el-tab-pane>
        </el-tabs>
      </el-form-item>
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">Previous step, fill in the product promotion</el-button>
        <el-button type="primary" size="medium" @click="handleNext">Next, select Product Link</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleSyncProductSkuPrice(){
        this.$confirm('Will synchronize the price of the first sku to all skus, whether to continue', 'hint', {
          confirmButtonText: 'Sure',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      handleSyncProductSkuStock(){
        this.$confirm('Will synchronize the inventory of the first sku to all skus, whether to continue ', 'tip', {
          confirmButtonText: 'Sure',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {

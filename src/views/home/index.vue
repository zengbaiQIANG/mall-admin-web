<template> 
  <div class="app-container">
    ...
    <div class="un-handle-layout">
      <div class="layout-title">Pending Tasks</div>
      <div class="un-handle-content">
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Pending Payment Orders</span>
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Orders Awaiting Confirmation</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Orders to be Shipped</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">New Out-of-Stock Registrations</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Ad Slots Expiring Soon</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
          ...
          <div class="out-border">
            ...
            <div style="padding: 40px">
              ...
              <el-row class="font-medium">
                <el-col :span="6" class="overview-item-title">Removed</el-col>
                <el-col :span="6" class="overview-item-title">Active</el-col>
                <el-col :span="6" class="overview-item-title">Low Stock</el-col>
                <el-col :span="6" class="overview-item-title">Total Products</el-col>
              </el-row>
            </div>
          </div>
        </el-col>
          ...
          <div style="padding: 20px">
            <div>
              ...
              <div>
                ...
                <span style="color: #C0C4CC;font-size: 14px">Compared to Last Month</span>
              </div>
            </div>
            <div style="margin-top: 20px;">
              ...
              <div>
                ...
                <span style="color: #C0C4CC;font-size: 14px">Compared to Last Week</span>
              </div>
            </div>
            <div style="margin-top: 20px;">
